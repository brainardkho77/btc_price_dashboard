...
## Run Summary
- Asset: `S&P 500 / SPX`
- Run ID: `spx_research_20260512T110524Z`
...
- `all_features_official` / `random_forest`: label `promising_but_rejected`, accuracy `62.6%`, net return `159.0%`, CI low `n/a`, p-value `n/a`, reason `current_all_features_reference`.
