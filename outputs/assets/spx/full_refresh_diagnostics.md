...
Quick mode used `2018-01-02` to `2026-05-07` with `75` 30d official samples and selected `random_forest`. Full refresh used `2015-01-02` to `2026-05-11` with `99` 30d official samples and selected `no_valid_edge`. The quick edge disappeared because the broader 2015+ sample added regimes where the ML models did not beat the 90d momentum baseline or the full baseline set after costs.
