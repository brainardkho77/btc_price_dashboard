...
## Run Summary
- Asset: `BTC`
- Run ID: `btc_research_20260507T141045Z`
- Selected model: `no_valid_edge`
- Signal: `neutral`
- Reliability: `Low confidence`
- Current all-feature best ML: `logistic_linear` at `50.0%` accuracy, Brier `0.265`, net return `450.9%`.
- Best baseline: `momentum_90d` at `55.0%` accuracy.

## Best Pruned Candidate
- `all_features_official` / `logistic_linear`: samples `100`, accuracy `50.0%`, Brier `0.265`, calibration `0.114`, Sharpe `0.62`, drawdown `-66.6%`, net return `450.9%`.
