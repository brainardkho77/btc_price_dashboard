...
## Summary
- Full refresh run ID: `btc_research_20260529T094658Z`
...
- `random_forest` in `post_etf`: samples `27`, accuracy `63.0%`, net return `214.2%`, reliability `Low confidence`
...
- `random_forest` in `bear_market`: samples `45`, accuracy `55.6%`, net return `104.4%`, reliability `Low confidence`
- `momentum_90d` in `post_etf`: samples `27`, accuracy `55.6%`, net return `122.8%`, reliability `Low confidence`
- `logistic_linear` in `post_etf`: samples `27`, accuracy `55.6%`, net return `163.9%`, reliability `Low confidence`
...
- Best derivatives impact row: `logistic_linear`, derivatives included `False`, accuracy `63.6%`.
