...
DIAGNOSTIC_OUTPUT_SCHEMAS: Dict[str, List[str]] = {
    ...
    "sol_signal_policy_deployment.csv": [
        ...
        "valid_signal_policy",
        "promoted_signal_policy",
        "enough_active_signals",
        "high_confidence_active_floor_met",
        "deployment_role",
    ...
    "btc_edge_failure_audit.csv": [
        ...
        "n_samples",
        "directional_accuracy",
        "accuracy_gap_to_buy_hold",
        "accuracy_gap_to_momentum_30d",
        "accuracy_gap_to_momentum_90d",
        "accuracy_gap_to_random",
        "tc_adjusted_return",
        ...
        "max_drawdown",
        "bootstrap_ci_low",
        "bootstrap_ci_gap_to_50",
        "permutation_p_value",
        "permutation_gap_to_0_10",
        "beats_buy_hold",
        "beats_momentum_30d",
        "beats_momentum_90d",
        "beats_random_baseline",
    ...
    "btc_regime_filter_audit.csv": [
        ...
        "beats_random_baseline",
        "passes_transaction_cost_check",
        "passes_active_coverage_floor",
        "passes_bootstrap_gate",
        "passes_permutation_gate",
        "passes_regime_stability_gate",
        "promotion_eligible",
        "rescue_decision",
        "failed_gates",
        "rejection_reason",
    ...
    "btc_etf_flow_coverage.csv": [
        ...
        "last_date",
        "missing_pct",
        "latest_daily_net_flow_usd",
        "latest_7d_net_flow_usd",
        "latest_30d_net_flow_usd",
        "latest_ibit_share",
        "used_in_model",
        "failure_reason",
    ],
    ...
    "asset_deployability_report.csv": [
        ...
        "best_ml_model",
        "best_ml_accuracy",
        "best_ml_tc_adjusted_return",
        "best_baseline_model",
        "best_baseline_accuracy",
        "best_baseline_tc_adjusted_return",
